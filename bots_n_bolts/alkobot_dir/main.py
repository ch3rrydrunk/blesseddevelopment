...
def menu_1_1_1(update, context):
    update.callback_query.edit_message_text(text=menu_1_1_1_message(),
                                            parse_mode=telegram.ParseMode.HTML,
                                            reply_markup=menu_1_1_1_keyboard())
    return CATALOG


def menu_1_1_2(update, context):
    query = update.callback_query
    update.edit_message_text(chat_id=query.message.chat_id,
...
con_handler = ConversationHandler(
    ...
    states={
        ...
        CATALOG: [CallbackQueryHandler(main_menu_kastil_nemnogo_koroche_moego_hera, pattern='^main$'),
                  ...
                  CallbackQueryHandler(menu_1_1_1, pattern='^m1_1_1$'),
                  CallbackQueryHandler(menu_1_1_2, pattern='^m1_1_2$'),
